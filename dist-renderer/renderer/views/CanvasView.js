...
export class CanvasView {
    constructor(plotModel) {
        // A3 dimensions in mm
        this.A3_WIDTH_MM = 297;
        this.A3_HEIGHT_MM = 420;
        this.drawDots = false;
    ...
    setupCanvas() {
        ...
        const zoom = Math.min((this.canvas.width - padding * 2) / this.A3_WIDTH_MM, (this.canvas.height - padding * 2) / this.A3_HEIGHT_MM);
    ...
    drawEntity(entity, isSelected, zoom, ctx) {
        ctx.save();
    ...
    scaleEntity(entity, handle, worldX, worldY) {
