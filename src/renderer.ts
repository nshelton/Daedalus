...
function setupEventListeners(): void {
    ...
    plotCanvas.addEventListener('contextmenu', (e: MouseEvent) => PathTools.showContextMenu(e.clientX, e.clientY, e.offsetX, e.offsetY, (entity: PlotEntity) => entities.push(entity)));
