...
contextBridge.exposeInMainWorld('electronAPI', {
    ...
    enqueueSmBatch: (moves) => ipcRenderer.invoke('plotter-enqueue-sm-batch', moves),
    enqueuePen: (up) => ipcRenderer.invoke('plotter-enqueue-pen', up),
    // File operations
    openPlotFile: () => ipcRenderer.invoke('open-plot-file'),
    // App model persistence
    saveAppModel: (jsonString) => ipcRenderer.invoke('appmodel-save', jsonString),
