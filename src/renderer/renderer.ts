...
function drawA3Paper(ctx: CanvasRenderingContext2D, zoom: number): void {
...
function drawEntity(ctx: CanvasRenderingContext2D, entity: PlotEntity, isSelected: boolean, zoom: number): void {
    ctx.save();
