export class PlotterGUIView {
    ...
    constructor(rootId: string = 'gui-root') {
    ...
    hideAll(): void {
        const contents = this.root.querySelectorAll('.gui-section-content') as NodeListOf<HTMLElement>;
        const headers = this.root.querySelectorAll('.gui-section-header span') as NodeListOf<HTMLElement>;
